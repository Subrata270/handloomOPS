    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold text-slate-900">Add new customer</h1>
          <p className="mt-2 text-sm text-slate-600">Create a new customer profile and save purchase preferences.</p>
        </div>
      </div>
